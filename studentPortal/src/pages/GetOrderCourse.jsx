      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
        <div className="bg-white p-10 rounded-2xl shadow-lg text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Your payment is not completed yet. Complete payment to access this
            course.
          </p>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6 mb-8">
          <div className="flex items-center gap-5">
            <img
              src={`${API}/image/${cour.coursesId.courseImage}`}
              alt=""
              ...
              assignments.map((assign) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <h2 className="text-xl font-semibold">{assign.title}</h2>
                  ...
                  <p className="text-gray-600 mt-3">{assign.description}</p>
                  ...
                  <div className="mt-6 border-t pt-5">
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                      ...
                      <button
                        onClick={() => submitAssignment(assign._id)}
